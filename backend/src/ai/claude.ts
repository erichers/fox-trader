...
- LONG OPTIONS ONLY (calls = bullish, puts = bearish). Never buy or sell stock or ETFs. A stock sell is allowed only to flatten a leftover equity position, never to open one.
