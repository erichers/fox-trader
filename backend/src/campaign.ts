  ...
  return [
    {
      ...
      bots: [
        { key: 'ign-mu-calls', name: 'MU catalyst calls', symbols: ['MU'], asset_class: 'option', why: 'Memory/HBM supercycle leader; earnings + AI-capex catalysts.', action: { option_type: 'call', strike_target: 'otm', expiration: 'weekly' }, rules: { rsi_below: 45 }, risk: { max_position_usd: 250, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
        { key: 'ign-nvda-calls', name: 'NVDA momentum calls', symbols: ['NVDA'], asset_class: 'option', why: 'AI compute bellwether; trend + breakout entries.', action: { option_type: 'call', strike_target: 'atm', expiration: 'weekly' }, rules: { ema_cross: 'golden' }, risk: { max_position_usd: 250, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
      ],
    },
    {
      ...
      bots: [
        ...
        { key: 'mom-ceg-power', name: 'CEG nuclear/AI-power calls', symbols: ['CEG'], asset_class: 'option', why: 'Beaten-down nuclear generator with TMI/Crane restart + Microsoft PPA; July NRC + earnings catalysts.', action: { option_type: 'call', strike_target: 'atm', expiration: 'weekly' }, risk: { max_position_usd: 800, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
        { key: 'mom-megacap-swing', name: 'Mega-cap momentum swings (QQQ/SPY/META/TSLA)', symbols: ['QQQ', 'SPY', 'META', 'TSLA'], asset_class: 'option', why: 'More PREDICTABLE, liquid large-cap/index swings to smooth the curve between single-name catalysts; META carries the software/AI-comeback tilt, TSLA the robotaxi optionality.', action: { option_type: 'call', strike_target: 'atm', expiration: 'weekly' }, rules: { ema_cross: 'golden' }, risk: { max_position_usd: 800, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
      ],
    },
    {
      ...
      bots: [
        { key: 'cmp-spy-event', name: 'SPY event debit spreads', symbols: ['SPY'], asset_class: 'option', why: 'Defined-risk index plays around FOMC / CPI / midterm catalysts.', action: { option_type: 'call', strike_target: 'atm', expiration: 'weekly' }, risk: { max_position_usd: 2500, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
        { key: 'cmp-dip-buyer', name: 'Macro dip-buyer', symbols: ['QQQ', 'SPY', 'NVDA', 'META', 'TSLA'], asset_class: 'option', why: 'Buy oversold bounces (RSI<35) in the leaders + liquid mega-caps during volatility.', action: { option_type: 'call', strike_target: 'otm', expiration: 'weekly' }, rules: { rsi_below: 35 }, risk: { max_position_usd: 2000, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
      ],
    },
    {
      ...
      bots: [
        { key: 'psh-hedge', name: 'Tail-risk put hedge', symbols: ['SPY'], asset_class: 'option', why: 'A long put guard for election/war volatility while you finish the climb.', action: { option_type: 'put', strike_target: 'otm', expiration: 'weekly' }, risk: { max_position_usd: 3000, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
        { key: 'psh-best-ideas', name: 'Best-ideas calls', symbols: ['NVDA', 'MU', 'QQQ'], asset_class: 'option', why: 'Concentrate the final push in your 1–2 highest-conviction names.', action: { option_type: 'call', strike_target: 'atm', expiration: 'weekly' }, risk: { max_position_usd: 4000, stop_loss_pct: 10, take_profit_pct: 0, trailing_stop_pct: 12 } },
      ],
    },
  ];
}
