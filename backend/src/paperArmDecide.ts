...
export const MAC_DESK = {
  grokbotRoot: join(_home, 'Sites/grokbot'),
  repo: join(_home, 'Sites/grokbot/grokbot-rh-trader'),
  mamp: 'http://localhost:8888/grokbot/grokbot-rh-trader/',
  api: 'http://127.0.0.1:8011/',
  legacy: join(_home, 'Sites/rh.tradingbot'),
  sibling: join(_home, 'Sites/grokbot-rhtrader'),
  wrongName: join(_home, 'Sites/grokbot/rh-trader'),
