...
export const STRATEGY_LIBRARY: StrategyTemplate[] = [
  ...
  },
  {
    ...
    action: { side: 'buy', qty: 1, order_type: 'market', option_type: 'call', strike_target: 'otm', expiration: 'weekly' },
  ...
  },
  {
    ...
    action: { side: 'buy', qty: 1, order_type: 'market', option_type: 'put', strike_target: 'otm', expiration: 'weekly' },
