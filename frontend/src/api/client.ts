...
export const LeapsIdeas = () => api.get('/ideas/leaps');
export const EnableLeapsIdea = (id: string) => api.post(`/ideas/leaps/${encodeURIComponent(id)}/enable`);
export const ObserveLeapsIdea = (id: string) => api.post(`/ideas/leaps/${encodeURIComponent(id)}/observe`);
...
export const Desk = () => api.get('/desk');
export const SetDeskPolicy = (body: { mode?: string; amount_usd?: number; max_usd?: number; maxPositionUsd?: number; all_bots_full_auto?: boolean }) =>
  api.post('/desk/policy', body);
