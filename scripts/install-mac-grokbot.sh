#!/usr/bin/env bash
# Put this paper-desk checkout at ${HOME}/Sites/grokbot/grokbot-rh-trader and wire MAMP.
...
GROKBOT_ROOT="${RH_GROKBOT_ROOT:-${HOME}/Sites/grokbot}"
TARGET="${GROKBOT_ROOT}/grokbot-rh-trader"
LEGACY="${HOME}/Sites/rh.tradingbot"
WRONG_NAME="${GROKBOT_ROOT}/rh-trader"
SIBLING="${HOME}/Sites/grokbot-rhtrader"
